! function(t) {
	function o(t) {
		return "undefined" == typeof t.which ? !0 : "number" == typeof t.which && t.which > 0 ? !t.ctrlKey && !t.metaKey && !
			t.altKey && 8 != t.which && 9 != t.which && 13 != t.which && 16 != t.which && 17 != t.which && 20 != t.which && 27 !=
			t.which : !1
	}
	...
	t.expr[":"].notmdproc = function(o) {
		...
		input: function(o) {
			t(o ? o : this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function() {
				...
				0 === i.length && (o.wrap("<div class='form-group'></div>"), i = o.closest(".form-group")), o.attr("data-hint") &&
				...
				if (t.each(n, function(t, n) {
					...
					var a = o.attr("id"),
						r = "";
					a && (r = "for='" + a + "'"), i.addClass("label-floating"), o.after("<label " + r + "class='control-label'>" +
						e + "</label>")
				}(null === o.val() || "undefined" == o.val() || "" === o.val()) && i.addClass("is-empty"), i.append(
					"<span class='material-input'></span>"), i.find("input[type=file]").length > 0 && i.addClass("is-fileinput")
			})
		},
		attachInputEventHandlers: function() {
			...
			t(document).on("change", ".checkbox input[type=checkbox]", function() {
				...
				if($(this).attr("class").indexOf("reg_phone") > -1){
					var value = $(".reg_phone").val();
					$(".reg-tip").html("");
					if(phoneReg.test(value)||value=="") {
						$(".reg-phone").removeClass("has-error");
					}else{
						$(".reg-phone").addClass("has-error");
					}
				}else if($(this).attr("class").indexOf("log_phone") > -1){
					var value = $(".log_phone").val()
					if(phoneReg.test(value)||value=="") {
						$(".log-phone").removeClass("has-error");
						
					}else{
					   $(".log-phone").addClass("has-error");
					}
				}else if($(this).attr("class").indexOf("yz_phone") > -1){
					var value = $(".yz_phone").val()
					if(phoneReg.test(value)||value=="") {
						$(".yz-phone").removeClass("has-error");
						
					}else{
					   $(".yz-phone").addClass("has-error");
					}
				}else{
					var o = t(this),
						i = o.closest(".form-group"),
						e = "undefined" == typeof o[0].checkValidity || o[0].checkValidity();
					"" === o.val() ? i.addClass("is-empty") : i.removeClass("is-empty"), n && (e ? i.removeClass("has-error") 
				...
				t.each(this.files, function(t, o) {
					n += o.name + ", "
				}), n = n.substring(0, n.length - 2), n ? i.removeClass("is-empty") : i.addClass("is-empty"), i.find(
		...
		init: function(o) {
			...
			var i = t(document);
			t.fn.ripples && this.options.ripples && this.ripples(), this.options.input && (this.input(), this.attachInputEventHandlers()),
				this.options.checkbox && this.checkbox(), this.options.togglebutton && this.togglebutton(), this.options.radio &&
				this.radio(), this.options.autofill && (this.autofill(), this.attachAutofillEventHandlers()), document.arrive &&
				this.options.arrive && (t.fn.ripples && this.options.ripples && i.arrive(this.options.withRipples, function() {
